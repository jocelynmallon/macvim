...
int utf_eat_space __ARGS((int cc));
int dbcs_eat_space __ARGS((int cc));
int utf_allow_break_after __ARGS((int cc));
int utf_allow_break_before __ARGS((int cc));
int utf_allow_break __ARGS((int cc, int ncc));
int dbcs_allow_break_after __ARGS((int cc));
int dbcs_allow_break_before __ARGS((int cc));
int dbcs_allow_break __ARGS((int cc, int ncc));
